...
STATIC_DIR = REPO_ROOT / "web" / "labeler-loop"
DATA_DIR = REPO_ROOT / "data" / "labeler-loop"
LABELS_PATH = DATA_DIR / "labels.jsonl"
AUDIO_DIR = DATA_DIR / "audio"

GOOD_REASON_TAGS: list[dict[str, str]] = [
    {"id": "tempo_good", "desc": "繝・Φ繝晁憶縺・遏ｭ縺・},
    {"id": "metaphor_good", "desc": "豈泌湊縺悟絢縺輔ｋ"},
    {"id": "punch_good", "desc": "霑ｽ縺・遠縺｡縺悟柑縺・※縺・ｋ"},
    {"id": "wrap_good", "desc": "繧ｪ繝・蟾ｻ縺榊叙繧翫′濶ｯ縺・},
    {"id": "character_good", "desc": "繧ｭ繝｣繝ｩ縺檎ｫ九▲縺ｦ縺・ｋ"},
]

BAD_REASON_TAGS: list[dict[str, str]] = [
    {"id": "too_long", "desc": "髟ｷ縺・},
    {"id": "too_safe", "desc": "辟｡髮｣/豁｣隲・},
    {"id": "unclear", "desc": "諢丞袖縺悟・縺九ｉ縺ｪ縺・},
    {"id": "too_mean", "desc": "蛻ｺ縺鈴℃縺・蜊ｱ髯ｺ蟇・ｊ"},
    {"id": "off_context", "desc": "迥ｶ豕√ぜ繝ｬ"},
]
...
app = FastAPI(title="labeler-loop")
