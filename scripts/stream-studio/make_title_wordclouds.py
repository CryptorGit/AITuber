...
def main() -> int:
    ...
    parser.add_argument("--streams-root", default="data/stream-studio/finetune/youtube/meta/streams")
    parser.add_argument("--out-root", default="data/stream-studio/finetune/youtube/meta/wordclouds")
