...
def main() -> int:
    ...
    parser.add_argument(
        "--root",
        default="data/stream-studio/finetune/youtube/meta/streams",
        help="Root folder containing subfolders (default: data/stream-studio/finetune/youtube/meta/streams)",
    )
