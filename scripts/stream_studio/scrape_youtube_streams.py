...
def main() -> int:
    ...
    parser.add_argument(
        "--out-jsonl",
        default="data/stream_studio/finetune/youtube/meta/streams.jsonl",
        help="Output JSONL path (default: data/stream_studio/finetune/youtube/meta/streams.jsonl)",
    )
    parser.add_argument(
        "--out-csv",
        default="data/stream_studio/finetune/youtube/meta/streams.csv",
        help="Output CSV path (default: data/stream_studio/finetune/youtube/meta/streams.csv)",
    )
    parser.add_argument(
        "--out-failed-jsonl",
        default=None,
