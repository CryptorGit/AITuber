...
def main() -> int:
    ...
    parser.add_argument(
        "--root",
        default="data/stream_studio/finetune/youtube/meta/streams",
        help="Root folder containing subfolders (default: data/stream_studio/finetune/youtube/meta/streams)",
    )
