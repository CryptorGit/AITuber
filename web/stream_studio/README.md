...
`data/stream_studio/web/models/<name>/` 配下にモデルを配置してください（サーバーが `/models` として配信します）。

例:
- `data/stream_studio/web/models/haru/haru.model3.json`
- `data/stream_studio/web/models/haru/motions/01_greet.motion3.json`
...
`web/stream_studio/hotkeys.json` は `motion_tags -> motion file path` の辞書です。
